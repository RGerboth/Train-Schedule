...
## Overview
The Train Schedule is primarily an exercise in moment.js and recursive JavaScript using setTimeout. Train name, destination, first train time and interval (frequency in minutes) are stored in Firebase*. On page launch, all of the current schedules are loaded 
...
* Data storage could easily be converted to a single SQL table or mongoDB collection as different implementation environments might require. 
